...
export async function get_all_users(): Promise<User[]>{
    ...
    let error_title = "Erreur lors de la récupération de la liste des utilisateurs"
    try {
...
export async function add_user(email: string, role: "admin" | "waiter"): Promise<boolean>{
...
export async function update_role(email: string, new_role: "admin" | "waiter"): Promise<boolean>{
